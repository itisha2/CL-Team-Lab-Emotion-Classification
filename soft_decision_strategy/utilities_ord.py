...
"""
This script has all the dependent methods
"""
...
def final_output(row):
    """
    :param row: predictions from the three classifiers
        1. Overlapping region detector
        2. 2 classifiers of the soft decision maker
    :return: return top, top second and top third recommendation
    """
    flag = 0
    out = []
